cmd_libbb/speed_table.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.speed_table.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie -DIR0_INTERACTIVE_GUI   -DKBUILD_BASENAME='"speed_table"'  -DKBUILD_MODNAME='"speed_table"' -c -o libbb/speed_table.o libbb/speed_table.c
