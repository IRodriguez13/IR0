...
int64_t sys_kernel_info(void *info_buffer, size_t buffer_size)
{
    ...
    if (buffer_size < len) len = buffer_size;
...
void sys_exit_wrapper(syscall_args_t *args) {
    sys_exit((int)args->arg1);
}

void sys_write_wrapper(syscall_args_t *args) {
    args->arg1 = sys_write((int)args->arg1, (void*)args->arg2, (size_t)args->arg3);
}

void sys_read_wrapper(syscall_args_t *args) {
    args->arg1 = sys_read((int)args->arg1, (void*)args->arg2, (size_t)args->arg3);
}
...
void sys_ps_wrapper(syscall_args_t *args) {
    args->arg1 = sys_ps();
}
