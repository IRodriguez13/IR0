cmd_coreutils/true.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,coreutils/.true.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"true"'  -DKBUILD_MODNAME='"true"' -c -o coreutils/true.o coreutils/true.c
