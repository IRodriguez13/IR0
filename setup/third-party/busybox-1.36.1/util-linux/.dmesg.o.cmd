cmd_util-linux/dmesg.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,util-linux/.dmesg.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"dmesg"'  -DKBUILD_MODNAME='"dmesg"' -c -o util-linux/dmesg.o util-linux/dmesg.c
