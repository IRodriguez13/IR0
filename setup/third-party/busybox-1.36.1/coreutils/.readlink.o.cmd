cmd_coreutils/readlink.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,coreutils/.readlink.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"readlink"'  -DKBUILD_MODNAME='"readlink"' -c -o coreutils/readlink.o coreutils/readlink.c
