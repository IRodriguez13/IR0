cmd_archival/libarchive/common.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,archival/libarchive/.common.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie -DIR0_INTERACTIVE_GUI   -DKBUILD_BASENAME='"common"'  -DKBUILD_MODNAME='"common"' -c -o archival/libarchive/common.o archival/libarchive/common.c
