cmd_libbb/get_shell_name.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.get_shell_name.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"get_shell_name"'  -DKBUILD_MODNAME='"get_shell_name"' -c -o libbb/get_shell_name.o libbb/get_shell_name.c
