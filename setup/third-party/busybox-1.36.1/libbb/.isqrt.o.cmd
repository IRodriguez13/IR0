cmd_libbb/isqrt.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.isqrt.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"isqrt"'  -DKBUILD_MODNAME='"isqrt"' -c -o libbb/isqrt.o libbb/isqrt.c
