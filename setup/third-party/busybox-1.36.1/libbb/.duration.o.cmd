cmd_libbb/duration.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.duration.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"duration"'  -DKBUILD_MODNAME='"duration"' -c -o libbb/duration.o libbb/duration.c
