cmd_console-tools/clear.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,console-tools/.clear.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"clear"'  -DKBUILD_MODNAME='"clear"' -c -o console-tools/clear.o console-tools/clear.c
