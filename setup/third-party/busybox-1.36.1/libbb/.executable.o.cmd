cmd_libbb/executable.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.executable.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"executable"'  -DKBUILD_MODNAME='"executable"' -c -o libbb/executable.o libbb/executable.c
