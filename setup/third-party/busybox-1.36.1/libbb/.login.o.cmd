cmd_libbb/login.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.login.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"login"'  -DKBUILD_MODNAME='"login"' -c -o libbb/login.o libbb/login.c
