cmd_coreutils/ln.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,coreutils/.ln.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"ln"'  -DKBUILD_MODNAME='"ln"' -c -o coreutils/ln.o coreutils/ln.c
