...
### ✅ Working Components
- **✅ Dual Architecture Support**: x86-32 and x86-64 compilation and boot
- **✅ Memory Management**: Basic paging, heap allocator, physical memory management
- **✅ Interrupt System**: Complete IDT setup, PIC configuration, ISR handlers, TSS for x86-64
- **✅ Process Management**: Process structure and state management framework with multiple schedulers
- **✅ System Calls Interface**: POSIX-compatible system call definitions
- **✅ Interactive Shell**: Basic shell with command parsing and execution
...
### Prerequisites
- GCC/G++/CLANG with multilib support
- NASM assembler
- QEMU for testing
- Make
...
### Quick Build
```bash
make all                    # Build kernel for current architecture
...
pwd                     # Print working directory -- not implemented
cat                     # Display file contents -- not implemented
mkdir                   # Create directory
rm                      # Remove file -- not implemented
cp                      # Copy file -- not implemented
mv                      # Move file -- not implemented
...
halt                    # Halt system -- not implemented
kill                    # Kill process -- not implemented
sleep                   # Sleep for seconds -- not implemented
...
- **[Developer Guide](setup/docs/DEVELOPER_GUIDE.md)** - Development guidelines and patterns
...
We welcome contributions! Please see our [Developer Guide](setup/docs/DEVELOPER_GUIDE.md) for:
