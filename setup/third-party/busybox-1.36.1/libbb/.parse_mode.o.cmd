cmd_libbb/parse_mode.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.parse_mode.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"parse_mode"'  -DKBUILD_MODNAME='"parse_mode"' -c -o libbb/parse_mode.o libbb/parse_mode.c
