...
task_t *get_current_task(void);                  // Obtener tarea actual
void set_current_task_null(void);                // Limpiar referencia de tarea actual
void terminate_current_task(void);               // Terminar tarea actual y cambiar a siguiente
