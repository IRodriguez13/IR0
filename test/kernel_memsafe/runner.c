 ...
 * Compila código del kernel para el host con dependencias mínimas y corre
 * Valgrind para detectar leaks y errores de memoria en esas rutas.
 *
 * Uso: make kernel-memsafe (desde la raíz) o make all && valgrind ./ir0_kernel_memsafe
 */
