cmd_libbb/get_console.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.get_console.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie -DIR0_INTERACTIVE_GUI   -DKBUILD_BASENAME='"get_console"'  -DKBUILD_MODNAME='"get_console"' -c -o libbb/get_console.o libbb/get_console.c
