cmd_libbb/xfuncs.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.xfuncs.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"xfuncs"'  -DKBUILD_MODNAME='"xfuncs"' -c -o libbb/xfuncs.o libbb/xfuncs.c
