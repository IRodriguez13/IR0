cmd_procps/kill.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,procps/.kill.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"kill"'  -DKBUILD_MODNAME='"kill"' -c -o procps/kill.o procps/kill.c
