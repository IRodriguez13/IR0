cmd_coreutils/test.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,coreutils/.test.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"test"'  -DKBUILD_MODNAME='"test"' -c -o coreutils/test.o coreutils/test.c
