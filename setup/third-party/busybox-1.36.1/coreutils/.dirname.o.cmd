cmd_coreutils/dirname.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,coreutils/.dirname.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"dirname"'  -DKBUILD_MODNAME='"dirname"' -c -o coreutils/dirname.o coreutils/dirname.c
