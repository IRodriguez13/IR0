cmd_libbb/bb_bswap_64.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.bb_bswap_64.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie -DIR0_INTERACTIVE_GUI   -DKBUILD_BASENAME='"bb_bswap_64"'  -DKBUILD_MODNAME='"bb_bswap_64"' -c -o libbb/bb_bswap_64.o libbb/bb_bswap_64.c
