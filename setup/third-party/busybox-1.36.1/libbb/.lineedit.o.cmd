cmd_libbb/lineedit.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.lineedit.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie -DIR0_INTERACTIVE_GUI   -DKBUILD_BASENAME='"lineedit"'  -DKBUILD_MODNAME='"lineedit"' -c -o libbb/lineedit.o libbb/lineedit.c
