cmd_coreutils/wc.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,coreutils/.wc.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"wc"'  -DKBUILD_MODNAME='"wc"' -c -o coreutils/wc.o coreutils/wc.c
