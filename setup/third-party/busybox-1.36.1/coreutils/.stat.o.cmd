cmd_coreutils/stat.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,coreutils/.stat.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"stat"'  -DKBUILD_MODNAME='"stat"' -c -o coreutils/stat.o coreutils/stat.c
