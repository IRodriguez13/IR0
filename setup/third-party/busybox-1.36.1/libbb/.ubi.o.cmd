cmd_libbb/ubi.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.ubi.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"ubi"'  -DKBUILD_MODNAME='"ubi"' -c -o libbb/ubi.o libbb/ubi.c
