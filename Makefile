...
help:
	...
	@echo "  make tooling-check                     # fast host gate (arch-guard, tests, contracts)"
	@echo "  make ci-local                          # pre-push: fast + Docker E2E (WIP tree)"
	@echo "  make ci-local-fast                     # ~1 min unit/arch/contracts only"
	@echo "  make ci-local-boot                     # + host ISO/kmang/QEMU/guest probes"
	@echo "  make ci-local-docker                   # Docker E2E on bind-mounted WIP"
