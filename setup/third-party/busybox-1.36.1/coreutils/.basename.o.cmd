cmd_coreutils/basename.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,coreutils/.basename.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"basename"'  -DKBUILD_MODNAME='"basename"' -c -o coreutils/basename.o coreutils/basename.c
