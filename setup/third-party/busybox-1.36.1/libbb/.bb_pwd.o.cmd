cmd_libbb/bb_pwd.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.bb_pwd.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"bb_pwd"'  -DKBUILD_MODNAME='"bb_pwd"' -c -o libbb/bb_pwd.o libbb/bb_pwd.c
