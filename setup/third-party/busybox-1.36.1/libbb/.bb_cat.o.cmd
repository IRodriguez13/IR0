cmd_libbb/bb_cat.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.bb_cat.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"bb_cat"'  -DKBUILD_MODNAME='"bb_cat"' -c -o libbb/bb_cat.o libbb/bb_cat.c
