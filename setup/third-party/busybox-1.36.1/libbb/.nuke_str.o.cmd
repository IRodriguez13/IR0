cmd_libbb/nuke_str.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.nuke_str.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie -DIR0_INTERACTIVE_GUI   -DKBUILD_BASENAME='"nuke_str"'  -DKBUILD_MODNAME='"nuke_str"' -c -o libbb/nuke_str.o libbb/nuke_str.c
