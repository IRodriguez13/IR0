cmd_coreutils/printf.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,coreutils/.printf.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"printf"'  -DKBUILD_MODNAME='"printf"' -c -o coreutils/printf.o coreutils/printf.c
