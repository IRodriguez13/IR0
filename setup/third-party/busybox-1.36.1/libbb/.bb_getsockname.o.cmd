cmd_libbb/bb_getsockname.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.bb_getsockname.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"bb_getsockname"'  -DKBUILD_MODNAME='"bb_getsockname"' -c -o libbb/bb_getsockname.o libbb/bb_getsockname.c
