cmd_libbb/missing_syscalls.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.missing_syscalls.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie -DIR0_INTERACTIVE_GUI   -DKBUILD_BASENAME='"missing_syscalls"'  -DKBUILD_MODNAME='"missing_syscalls"' -c -o libbb/missing_syscalls.o libbb/missing_syscalls.c
