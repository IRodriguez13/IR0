cmd_coreutils/sleep.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,coreutils/.sleep.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"sleep"'  -DKBUILD_MODNAME='"sleep"' -c -o coreutils/sleep.o coreutils/sleep.c
