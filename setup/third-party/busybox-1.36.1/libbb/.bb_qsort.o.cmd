cmd_libbb/bb_qsort.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.bb_qsort.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie -DIR0_INTERACTIVE_GUI   -DKBUILD_BASENAME='"bb_qsort"'  -DKBUILD_MODNAME='"bb_qsort"' -c -o libbb/bb_qsort.o libbb/bb_qsort.c
