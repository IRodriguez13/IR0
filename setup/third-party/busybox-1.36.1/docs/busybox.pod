...
Currently available applets include:
	...
	ash, basename, cat, clear, cp, dirname, dmesg, echo, false, grep,
	head, kill, ln, ls, mkdir, mv, printf, ps, pwd, readlink, rm, rmdir,
	sh, sleep, stat, tail, test, touch, true, uname, wc
