cmd_libbb/single_argv.o := /usr/bin/x86_64-linux-musl-gcc -Wp,-MD,libbb/.single_argv.o.d  -std=gnu99 -Iinclude -Ilibbb  -include include/autoconf.h -D_GNU_SOURCE -DNDEBUG  -DBB_VER='"1.36.1"' -fno-pie    -DKBUILD_BASENAME='"single_argv"'  -DKBUILD_MODNAME='"single_argv"' -c -o libbb/single_argv.o libbb/single_argv.c
